...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderSlot } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><button class="text-[10px] tracking-[0.1em] uppercase px-3 py-1.5 transition-colors" style="${ssrRenderStyle({ "border": "1px solid var(--border)", "background": "none", "color": "var(--muted)" })}">${ssrInterpolate(unref(colorMode).value === "dark" ? "Light" : "Dark")}</button></div></header><main class="flex-1 pt-12 overflow-hidden">`);
...
//# sourceMappingURL=default-BR94txIi.mjs.map
